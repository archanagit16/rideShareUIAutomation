...
import com.rideshare.utils.DriverManager;
import com.rideshare.utils.GlobalParams;
...
public class BasePage {
    ...
    public void setLocation() {
        ...
        double latitude = Double.parseDouble("12.9784");
        double longitude = Double.parseDouble("77.6408");
        driver.setLocation(new Location(latitude, longitude, 45));

        // We can use the JSON to fetch lat lng for dynamic location
    }

    public WebElement waitForVisibility(MobileElement e) {
...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");
    ...
    public boolean isTextPresent(String text) {
        ...
        try {
            return waitForVisibility((MobileElement) driver.findElement(by)).isDisplayed();
        } catch (Exception ex) {
            return false;
        }
    }
